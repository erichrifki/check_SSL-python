...
TELEGRAM_CHAT_ID="-1002052177540" # Ganti dengan ID chat dari pengguna/grup/channel yang ingin Anda kirim pesan ke sana
...
done < data.py  # Ganti 'list_domain.txt' dengan nama file yang berisi daftar domain
